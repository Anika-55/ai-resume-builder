...
const ProfessionalSummaryForm = ({ data, onChange, setResumeData }) => {
  ...
  const generateSummary = async () => {
    try {
      ...
      setResumeData((prev) => ({
        ...prev,
        professional_summary: response.data.enhancedContext,
      }));
    } catch (error) {
    ...
    <div className="space-y-4">
      ...
      <div className="mt-6">
        <textarea
          ...
          placeholder="Write a compelling professional summary that highlights summary that highlights your key strengths and career objectives...."
        />
        <p className="text-xs text-gray-500 max-w-4/5 text-center">
