  ...
  return (
    <div className="">
      <div className="max-w-7xl mx-auto px-4 py-8">
        <p className="text-2xl font-me mb-6 bg-gradient-to-r from-slate-600 to-slate-700 bg-clip-text text-transparent sm:hidden">
          Welcome,Joe Doe
        </p>
        ...
        <div className="flex gap-4">
          ...
          >
            ...
            <p className="text-sm group-hover:text-indigo-500 transition-all">
              Create Resume
            </p>
          </button>
          <button
